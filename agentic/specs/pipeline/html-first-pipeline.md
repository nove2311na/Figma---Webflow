...
5. **Phase 6: Figma Tree Normalization** (`scripts/normalize_figma_nodes.py`)
6. **Phase 7: Semantic IR, Tag & Class Resolution**
7. **Phase 8: HTML Blueprint Rendering & QA** (`scripts/render_html_from_blueprint.py`)
8. **Phase 9: Asset & Alt Manifest Creation**
9. **Phase 10: Section Chunk Slicing** (`scripts/slice_html_into_chunks.py`)
10. **Phase 11: Webflow Native Build Plan Compiler** (`scripts/compile_native_ops_from_html.py`)
