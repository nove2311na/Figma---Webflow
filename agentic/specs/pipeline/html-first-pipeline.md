...
1. **Phase 2: CSS Contract Extraction** (`scripts/index_css_library.py`)
...
5. **Phase 6: Figma Tree Normalization** (`scripts/.claude/skills/_shared/scripts/resolve_client_first.py`)
6. **Phase 7: Semantic IR, Tag & Class Resolution**
7. **Phase 8: HTML Blueprint Rendering & QA** (`scripts/.claude/skills/_shared/scripts/index_css_library.py`)
8. **Phase 9: Asset & Alt Manifest Creation**
9. **Phase 10: Section Chunk Slicing** (`scripts/.claude/skills/_shared/scripts/resolve_client_first.py`)
10. **Phase 11: Webflow Native Build Plan Compiler** (`scripts/.claude/skills/_shared/scripts/validate_artifacts.py`)
